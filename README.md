...
## 🚀 Project Overview
단순히 법조문을 나열하는 기존 챗봇의 한계를 넘어, 본 프로젝트는 사용자가 처한 복잡한 시나리오를 분석하여 실질적인 해결책을 제시하는 데 집중합니다. 로컬 환경에서 대한민국 법령 전수 수집을 성공적으로 완료하였으며, 이를 기반으로 고도화된 **RAG(Retrieval-Augmented Generation)** 에이전트를 구축합니다.
