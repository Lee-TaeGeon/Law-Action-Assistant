...
## 📊 Dataset on Kaggle
본 프로젝트에서 수집하고 정제한 데이터셋은 누구나 활용할 수 있도록 Kaggle에 공개되어 있습니다.
- 🔗 **[South Korea Current Statutes Dataset (JSON)](https://www.kaggle.com/datasets/ltg2757/south-korea-current-statutes-dataset-json)**
...
2.  **🛡️ 연관 법률 종합 진단 (Multi-Domain):** 단일 법령뿐만 아니라, 하나의 사건에서 발생할 수 있는 **민사적 책임**과 **형사적 책임**을 동시에 진단합니다. (**LangGraph Loop** 활용)
3.  **🎬 실행 가능한 대처법 (Action Plan) 제시:** 승소를 위해 필요한 구체적인 **증거물 체크리스트**와 단계별 대응 가이드를 생성합니다.
4.  **📑 실제 판례 사례 연결:** 사용자의 상황과 유사한 **실제 판례**를 매칭하여 답변의 신뢰성을 높입니다.
5.  **📝 법률 문서 초안 자동 생성:** 고소장, 내용증명 등 필수 법률 문서의 기초 드래프트(Draft)를 작성합니다.

## 📈 Data Engineering (Status: Completed)
- **Source:** 국가법령정보센터(law.go.kr) API
- [x] API 연동 및 고성능 배치 수집 엔진 구현
- [x] 대한민국 현행법령 전수 수집 완료
- [x] 56개 배치 파일 통합 및 데이터 정제 완료 (5,567건)
- [x] **Kaggle Dataset 업로드 및 공개 완료**

## 🛠 Tech Stack
- **Language:** Python 3.13
- **AI Frameworks:** **LangChain**, **LangGraph**
- **Monitoring:** **LangSmith**
- **Database:** Vector DB (**ChromaDB** 예정)
